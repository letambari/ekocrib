$(document).ready(function () {
  $("form").submit(function (event) {
    ...
    $.post("../../src/code/payment-status.php", formValues, function (data) {
 ...
 if (data == "success") {
        ...
        //   "https://spacebank.thalajaatdatabase.online/api/payment-success.php"
        // );
 var successMessage = 'Awesome!!!, you will recieve a notification on the status of your transaction';

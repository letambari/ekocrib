...
<section class="py-14 py-lg-17 page-title bg-overlay-opacity-02" style="background-image: url('images/BG4.jpg');background-size: cover;background-position: center">
<div class="container">
...
<h4 class="fs-22 lh-15 mb-0 text-heading">Port Harcourt</h4>
</div>
</div>
<div class="card-body px-0 pt-3 pb-0">
<p class="card-text mb-0">
84/86b Aba Road, Opp. Govt. Craft Centre, Port Harcourt, Rivers State.</p>
<!-- <a href="tel:12390068668" class="d-block text-heading lh-2 hover-primary text-decoration-none">123 900
68668</a> -->
<!-- <a href="mailto:contact.sanfrancisco@homeid.com" class="d-block text-body hover-primary text-decoration-none">contact.sanfrancisco@homeid.com</a> -->
</div>
</div>
</div>
<div class="col-md-4 mb-6">
...
<div class="media-body">
<h4 class="fs-22 lh-15 mb-0 text-heading">Enugu Office</h4>
</div>
</div>
<div class="card-body px-0 pt-3 pb-0">
<p class="card-text mb-0">
33 Zik Avenue, Uwani, Enugu State.
(FSP Skill-Aquisition Centre)
</p>
<!-- <a href="tel:123-900-68668" class="d-block text-heading lh-2 hover-primary text-decoration-none">123 900
68668</a>
<a href="mailto:contact.newyork@homeid.com" class="d-block text-body hover-primary text-decoration-none">contact.newyork@homeid.com</a> -->
</div>
</div>
</div>
<div class="col-md-4 mb-6">
...
<div class="media-body">
<h4 class="fs-22 lh-15 mb-0 text-heading">Ebonyi State</h4>
</div>
</div>
<div class="card-body px-0 pt-3 pb-0">
<p class="card-text mb-0">
37 Ogoja Road. Abakaliki, Ebonyi State.
</p>
<!-- <a href="tel:123-900-68668" class="d-block text-heading lh-2 hover-primary text-decoration-none">123 900
68668</a>
<a href="mailto:contact.russia@homeid.com" class="d-block text-body hover-primary text-decoration-none">contact.russia@homeid.com</a> -->
</div>
</div>
</div>
</div>

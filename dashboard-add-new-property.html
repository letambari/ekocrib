...
<!-- Mirrored from templates.g5plus.net/homeid/dashboard-add-new-property.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Aug 2022 01:43:50 GMT -->
...
in</label>
<select class="form-control border-0 shadow-none form-control-lg selectpicker" title="Select" data-style="btn-lg py-2 h-52" id="list-in" name="list-in">
<option>For Rent</option>
<option>For Sale</option>
</select>
</div>
...
<input type="text" name="tax" class="form-control form-control-lg border-0" id="tax">
</div>
</div>
</div>
<div class="form-row mx-n2">
...
Association Fee <span class="text-muted">(monthly)</span></label>
<input type="text" class="form-control form-control-lg border-0" id="fee" name="fee">
</div>
</div>
<div class="col-md-6 col-lg-12 col-xxl-6 px-2">
<div class="form-group">
<label for="after-price" class="text-heading">After Price Label <span class="text-muted">( ex: /month)</span>
</label>
<input type="text" class="form-control form-control-lg border-0" id="after-price" name="after-price">
</div>
</div>
</div>
<div class="form-row mx-n2">
...
Price label <span class="text-muted">(ex: "from")</span></label>
<input type="text" class="form-control form-control-lg border-0" id="before-price" name="before-price">
</div>
</div>
</div>
</div>
...
adipiscing elit</p>
<div class="form-group mb-0">
<label for="status" class="text-heading">Property Status</label>
<select class="form-control border-0 shadow-none form-control-lg selectpicker" title="Select" data-style="btn-lg py-2 h-52" id="status" name="status">
<option>For Rent</option>
<option>For Sale</option>
</select>
</div>
...
<p class="card-text mb-5">Lorem ipsum dolor sit amet, consectetur
adipiscing elit</p>
<div class="dropzone upload-file text-center py-5" data-uploader="true" id="myDropzone" data-uploader-url="./dashboard-add-new-property.html">
...
from </label>
<select class="form-control border-0 shadow-none form-control-lg selectpicker" data-style="btn-lg py-2 h-52" id="video-from" name="video-from">
<option>Vimeo</option>
...
<input type="text" name="embed-video-id" class="form-control form-control-lg border-0" id="embed-video-id">
</div>
</div>
</div>
</div>
...
adipiscing elit</p>
<div class="form-group mb-0">
<label for="virtual-tour" class="text-heading">Virtual Tour</label>
<input type="text" class="form-control form-control-lg border-0" id="virtual-tour" name="virtual-tour">
</div>
</div>
</div>
</div>
...
<input type="text" class="form-control form-control-lg border-0" id="address" name="address">
</div>
<div class="form-row mx-n2">
<div class="col-md-6 col-lg-12 col-xxl-6 px-2">
<div class="form-group">
...
State</label>
<input type="text" class="form-control form-control-lg border-0" id="state" name="state">
</div>
</div>
<div class="col-md-6 col-lg-12 col-xxl-6 px-2">
<div class="form-group">
<label for="city" class="text-heading">City</label>
<input type="text" class="form-control form-control-lg border-0" id="city" name="city">
</div>
</div>
</div>
<div class="form-row mx-n2">
...
<input type="text" class="form-control form-control-lg border-0" id="neighborhood" name="neighborhood">
</div>
</div>
<div class="col-md-6 col-lg-12 col-xxl-6 px-2">
<div class="form-group">
...
<input type="text" class="form-control form-control-lg border-0" id="size-in-ft" name="size-in-ft">
</div>
</div>
<div class="col-lg-4">
<div class="form-group">
<label for="lot-size-in-ft" class="text-heading">Lot size in ft <span class="text-muted">(only numbers)</span></label>
<input type="text" class="form-control form-control-lg border-0" id="lot-size-in-ft" name="lot-size-in-ft">
</div>
</div>
<div class="col-lg-4">
<div class="form-group">
...
<div class="col-lg-4">
<div class="form-group">
<label for="customID" class="text-heading">Custom ID <span class="text-muted">(text)</span></label>
<input type="text" class="form-control form-control-lg border-0" id="customID" name="customID">
</div>
 </div>
</div>
<div class="row">
...
<input type="text" class="form-control form-control-lg border-0" id="garage-size" name="garage-size">
</div>
</div>
<div class="col-lg-4">
<div class="form-group">
<label for="year-built" class="text-heading">Year built <span class="text-muted">(numeric)</span></label>
<input type="text" class="form-control form-control-lg border-0" id="year-built" name="year-built">
</div>
</div>
</div>
<div class="row">
...
<input type="date" class="form-control form-control-lg border-0" id="available-from" name="available-from">
</div>
</div>
<div class="col-lg-4">
<div class="form-group">
<label for="basement" class="text-heading">Basement</label>
<input type="text" class="form-control form-control-lg border-0" id="basement" name="basement">
</div>
</div>
<div class="col-lg-4">
<div class="form-group">
<label for="extra-details" class="text-heading">Extra details</label>
<input type="text" class="form-control form-control-lg border-0" id="extra-details" name="extra-details">
</div>
</div>
</div>
<div class="row">
...
<label for="roofing" class="text-heading">Roofing</label>
 <input type="text" class="form-control form-control-lg border-0" id="roofing" name="roofing">
</div>
</div>
<div class="col-lg-4">
<div class="form-group">
<label for="exterior-material" class="text-heading">Exterior Material</label>
<input type="text" class="form-control form-control-lg border-0" id="exterior-material" name="exterior-material">
</div>
</div>
<div class="col-lg-4">
<div class="form-group">
<label for="structure-type" class="text-heading">Structure type</label>
<select class="form-control border-0 shadow-none form-control-lg selectpicker" title="Select" data-style="btn-lg py-2 h-52" id="structure-type" name="structure-type">
<option>For Rent</option>
<option>For Sale</option>
</select>
</div>
...
<select class="form-control border-0 shadow-none form-control-lg selectpicker" title="Select" data-style="btn-lg py-2 h-52" id="floors-no" name="floors-no">
<option>1</option>
<option>2</option>
<option>3</option>
</select>
...
<label for="energy-class" class="text-heading">Energy Class</label>
<select class="form-control border-0 shadow-none form-control-lg selectpicker" title="Select" data-style="btn-lg py-2 h-52" id="energy-class" name="energy-class">
<option>1</option>
<option>2</option>
<option>3</option>
</select>
...
<div class="col-lg-6">
<div class="form-group mb-lg-0">
<label for="energy-index" class="text-heading">Energy index in kWh/m2a</label>
<select class="form-control border-0 shadow-none form-control-lg selectpicker" title="Select" data-style="btn-lg py-2 h-52" id="energy-index" name="energy-index">
<option>1</option>
<option>2</option>
<option>3</option>
</select>

...
// Message content
$message = 'Hello, your Spacebank Business verification code is: ' . $otp . '. or verify using the link http://localhost/spacebank-gateway/main/validate-otp?email=' . $device . '&otp=' . $otp . '';
